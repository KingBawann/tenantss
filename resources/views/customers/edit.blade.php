    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div class="flex items-center space-x-3">
                <a href="{{ route('customers.index') }}" class="text-slate-400 hover:text-slate-900 transition-colors">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl border border-slate-200">
                <form action="{{ route('customers.update', $customer->id) }}" method="POST" class="p-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <x-input-label for="balance" value="Current Balance ($) *" />
                            <x-text-input id="balance" class="block mt-1 w-full" type="number" step="0.01" name="balance" :value="old('balance', $customer->balance)" required />
