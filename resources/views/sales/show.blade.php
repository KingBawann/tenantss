    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div class="flex items-center gap-3">
                <a href="{{ route('sales.index') }}" class="text-slate-400 hover:text-slate-900 transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
                </a>
                <h2 class="font-bold text-2xl text-slate-900 leading-tight">
                    Sale Details <span class="text-slate-400 text-lg font-normal ml-2">#{{ str_pad($sale->id, 8, '0', STR_PAD_LEFT) }}</span>
                </h2>
            </div>
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div>
                                <p class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Payment Status</p>
                                <div class="flex gap-2">
                            ...
                            <div>
                                <p class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Cashier</p>
                            ...
                            <div>
                                <p class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Branch</p>
