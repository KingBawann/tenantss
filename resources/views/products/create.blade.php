                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="cost_price" class="block mt-1 w-full" type="number" step="0.01" name="cost_price" :value="old('cost_price')" required />
                            ...
                            {{-- Initial Stock --}}
                            <div>
                                <x-input-label for="stock_quantity" value="Initial Stock Quantity *" />
