                ...
                <form action="{{ route('products.store') }}" method="POST" class="p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            ...
                            {{-- Stock Quantity --}}
                            <div>
                                <label for="stock_quantity" class="block text-sm font-medium text-slate-300 mb-1">Initial Stock Quantity *</label>
                            ...
                            <div>
                                ...
                                <input type="number" id="reorder_point" name="reorder_point" value="{{ old('reorder_point', 5) }}"
                                    class="w-full bg-slate-800 border-white/10 text-slate-100 rounded-lg focus:border-blue-500 focus:ring-blue-500/20 text-sm">
                        ...
                        <div class="md:col-span-2 mt-4 space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="3"
                                    class="w-full bg-slate-800 border-white/10 text-slate-100 rounded-lg focus:border-blue-500 focus:ring-blue-500/20 text-sm">{{ old('description') }}</textarea>
